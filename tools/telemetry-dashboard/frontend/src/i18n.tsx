...
const ENGLISH: Record<string, string> = {
  ...
  ,"données non produites par le contrat CockpitSensors": "data not produced by the CockpitSensors contract"
  ...
  ,"Timeline du replay": "Replay timeline"
  ,"TIMELINE": "TIMELINE"
  ,"MARQUEURS": "MARKERS"
  ,"POINT D’ENTRÉE": "SET IN"
  ,"POINT DE SORTIE": "SET OUT"
  ,"Marqueurs enregistrés": "Saved markers"
  ,"Nom du marqueur": "Marker name"
  ,"Rechercher un marqueur": "Search markers"
  ,"AJOUTER": "ADD"
  ,"Renommer": "Rename"
  ,"Supprimer": "Delete"
  ,"Supprimer ce marqueur ?": "Delete this marker?"
  ,"Marqueur ajouté": "Marker added"
  ,"Marqueur modifié": "Marker updated"
  ,"Marqueur supprimé": "Marker deleted"
  ,"Session": "Session"
  ,"DÉSACTIVER LA BOUCLE": "DISABLE LOOP"
  ,"LIRE LA PLAGE EN BOUCLE": "LOOP ACTIVE RANGE"
  ,"SERVEUR UDP": "UDP SERVER"
  ,"ARRÊTÉ": "STOPPED"
  ,"CLIENTS": "CLIENTS"
  ,"INTERFACE": "INTERFACE"
  ,"PORT": "PORT"
  ,"ACTIVER LE LAN": "ENABLE LAN"
  ,"APPLIQUER": "APPLY"
  ,"ARRÊTER LE SERVEUR UDP": "STOP UDP SERVER"
  ,"DÉMARRER LE SERVEUR UDP": "START UDP SERVER"
  ,"RETOUR AU DIRECT": "RETURN TO LIVE"
  ,"BIBLIOTHÈQUE DES CAPTURES": "CAPTURE LIBRARY"
  ,"Bibliothèque des captures": "Capture library"
  ,"ATELIER DE REPLAY": "REPLAY WORKBENCH"
  ,"ENREGISTREMENT EN COURS": "RECORDING"
  ,"NOUVELLE CAPTURE": "NEW CAPTURE"
  ,"La capture reste ouverte pendant les reconnexions de FSO.": "The capture remains open across FSO reconnections."
  ,"TAILLE": "SIZE"
  ,"DURÉE": "DURATION"
  ,"DÉBIT 60 S": "60 S RATE"
  ,"ESPACE LIBRE": "FREE SPACE"
  ,"10 MIN": "10 MIN"
  ,"1 HEURE": "1 HOUR"
  ,"ESTIMATION FINALE": "FINAL ESTIMATE"
  ,"ARRÊTER ET FINALISER": "STOP AND FINALIZE"
  ,"Nom": "Name"
  ,"Durée prévue (minutes)": "Expected duration (minutes)"
  ,"DÉMARRER LA CAPTURE": "START CAPTURE"
  ,"Retournez au direct pour démarrer une capture.": "Return to live mode to start a capture."
  ,"REPLAY · LECTURE": "REPLAY · PLAYING"
  ,"REPLAY · PAUSE": "REPLAY · PAUSED"
  ,"Une capture est actuellement rejouée. Les données affichées ne proviennent pas directement de FSO.": "A capture is currently being replayed. The displayed data does not come directly from FSO."
  ,"Le replay est en pause. Les données affichées ne proviennent pas directement de FSO.": "Replay is paused. The displayed data does not come directly from FSO."
  ,"Rechercher une capture": "Search captures"
  ,"IMPORTER": "IMPORT"
  ,"Captures enregistrées": "Saved captures"
  ...
  ,"Supprimer définitivement cette capture ?": "Permanently delete this capture?"
  ,"Aucune capture": "No captures"
  ,"Capture importée": "Capture imported"
  ,"Capture chargée": "Capture loaded"
  ,"Retour au direct": "Returned to live"
  ,"Serveur UDP arrêté": "UDP server stopped"
  ,"Serveur UDP démarré": "UDP server started"
  ,"Paramètres UDP appliqués": "UDP settings applied"
  ,"Seuil d’avertissement de taille atteint": "Capture size warning threshold reached"
};
