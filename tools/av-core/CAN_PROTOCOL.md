...
| `0x182` | `LIGHTING_COMMAND` | AV CORE | WARN CTRL |
...
`ALL`, `WARN_CTRL` ou l'un des 23 identifiants de voyant et durent 2 000 ms.
...
`0=ALL`, `1=WARN_CTRL` et `2=LAMP`. Dans `LIGHTING_STATE`, `0xFF` indique
...
distantes sur `WARN CTRL` et fait clignoter `AV BUS`.
