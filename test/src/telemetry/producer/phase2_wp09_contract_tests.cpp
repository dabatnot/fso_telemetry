...
TEST(Phase2Wp09Contract, P2TST001LegacyConfigurationDefaultsSystemsToTenWithoutChangingOtherCadences)
{
...
TEST(Phase2Wp09Contract, P2TST002SystemsBoundsTypesAndIndependentSchedulersAreFailClosed)
{
...
TEST(Phase2Wp09Contract, P2TST003UnknownDuplicateAndDeepInputsNeverPartiallyApply)
{
	for (const auto* json : {
...
TEST(Phase2Wp09Contract, P2TST004DisabledConfigurationRetainsThePhase1FastPathDefaults)
{
...
TEST(Phase2Wp09Contract, P2TST005And006BuildSurfaceAndCMakeInventoryAreExplicit)
{
#if defined(_MSC_VER)
	...
	const auto target_end = cmake.find(
		"target_compile_features(telemetry_phase2_wp09_contract_tests",
		target_begin);
...
TEST(Phase2Wp09Contract, P2TST049ExactOwnedCapsPassAndEveryPlusOneFailsBeforeBind)
{
...
TEST(Phase2Wp09Contract, P2AC012Phase2MetricsAreClosedBoundedResettableAndHighWatered)
{
...
TEST(Phase2Wp09Contract, P2AC011DiagnosticsContainOnlyClosedNumericLabels)
{
	static_assert(std::is_trivially_copyable_v<detail::TelemetryMetricsSnapshot>);
