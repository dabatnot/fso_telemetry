...
Les budgets de Phase 4 sont définis avant implémentation par les limites FSTL et les allocations réellement nécessaires. Les plafonds fermés du profil `TrustedFullState` sont de 320 Mio pour le stockage partagé, 112 Mio par client et 768 Mio pour le processus avec quatre clients. Toute collection est préallouée ou refuse avant publication; aucune valeur de budget, seuil de performance ou campagne longue n’est une condition automatique de livraison.
